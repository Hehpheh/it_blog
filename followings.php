...
$followings = selectAll('followers', ['follower_id' => $_SESSION['id']]);
?>

<!doctype html>
<html lang="ru-scale=1.0, minimum-scale=1.0">
...
<div class="container">
    <div class="row">
        <div class="col-md-9 my-5" >
            <h1 class="m-3">Мои подписки</h1>
            <?php if (empty($followings)): ?>
                <p class="m-3">У вас пока нет подписок.</p>
            <?php else: ?>
                <?php foreach ($followings as $following):
                    // Получаем данные пользователя, на которого подписан текущий пользователь
                    $user = selectOne('users', ['id' => $following['author_id']]);
